...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Demo Keyword Rank Position Check</title>
        ...
        <div class="flex">
            <div class="rank-position" style="width:40%;max-height:600px;overflow:auto">
                <div class="match">
                    ...
                    @if ($item['match'])
                    <p> #{{$item['position']}} - {{ $item['title'] }} <br> {{ $item['link'] }} <br>{{ $item['snippet'] }}</p>
                    @endif
                    @endforeach
                </div>
                <div class="all">
            ...
            <iframe style="width:60%;height:600px"  frameborder="0" srcdoc="<base href=&quot;https://www.google.com/&quot; target=&quot;_blank&quot;>{{$html}}<script src=&quot;https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js&quot;></script><script>jQuery(document).ready(function(){ console.log(jQuery('div.MjjYud .yuRUbf'))  })</script>"></iframe>
        </div>
    </body>
</html>
